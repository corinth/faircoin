...
uint256 hashGenesisBlock("0xde806d3d5feafc37b448d7e5ed8ec6100df64ec9210fb453b60892815f689ec8");
...
//        nSubsidy = 0;
    if(nHeight > 2 * 10519200) // no block reward after 10 years
        nSubsidy = 0;

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 0.314159 * 24 * 60 * 60; // FairCoin: 0.314159 days
static const int64 nTargetSpacing = 32; // FairCoin: 32 seconds
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal faircoin miner
...
//        hashGenesisBlock = uint256("0xa50faf35e1dddf4a076a907fbcef6d9d1595390cdb1c818a35dae53b67ad0aa8");
	hashGenesisBlock = uint256("0xbba0c43e3e960810101821070ea4b334103b34a08f427cd80fa22c33b6ee24ec");
    }
...
//        const char* pszTimestamp = "todo: replace with something that ensures no premining took place";
	const char* pszTimestamp = "small explosion from an apparent dry ice bomb at Disneyland's Toontown on Tuesday afternoon";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
...
//        assert(block.hashMerkleRoot == uint256("0x5a2e19825b4162f68602039040f1e05d9f924ff00a3aff7327ca6abd6f3279bc"));
	assert(block.hashMerkleRoot == uint256("0x23b6916b1d8411930b249b062df7cdadb31b9c30951e27d8593143a42869fdb2"));
